...
# 1. 설정
# ==========================================
ANNOUNCEMENT = "📢 [필독] '강릉샌드' 각인이 있어야 정품입니다. 성곡고양길5번안길 31 본점인지 꼭 확인해주세요!"
SHEET_NAME = '슈퍼멤버스' 
...
with st.expander("ℹ️ [공식] 매장 안내 및 주의사항 (클릭해서 확인)"):
    st.markdown("""
    **⚠️ 유사품 주의**
    쿠키 겉면에 **'강릉샌드'** 글자가 각인되어 있는지 반드시 확인해주세요.
    
    **📍 본점 주소 (예약 시 꼭 확인!)**
    강원 강릉시 성곡고양길5번안길 31 (오죽헌 부근)
    
    **🏆 강릉샌드 수상내역**
    - 2022년 강릉시 관광기념품 공모전 금상 수상
    - 2025년 강릉시 관광기념품 공모전 은상 수상 (강릉 방파제빵)
    
    **🏠 기타 공식 매장**
    - 1호점 월화점: 강릉시 금성로12번길 6
    - 2호점 초당점: 강릉시 난설헌로 249
